...
Generate a camel project using defaults
    ...
    >fusegen -c fuse new camel-basic

Generate a camel project using 2.10.0.redhat-60060

    >fusegen -c fuse new -f 60060 -g com.mycompany.camel camel-basic

Generate a spring based cxf wsdl-first project

    >fusegen -c fuse new -g com.mycompany.camel cxf-wsdl-first

Generate a spring DMLC based jms consumer

    >fusegen -c amq new amq-consumer

Generate a multi-threaded jms producer

    >fusegen -c amq new amq-producer
